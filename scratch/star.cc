...
int main (int argc, char *argv[])
{
  ...
  devices3 = pointToPoint.Install (nodes.Get(1),nodes.Get(3));
  NetDeviceContainer devices4;
  devices4 = pointToPoint.Install (nodes.Get(1),nodes.Get(4));
  ...
  ApplicationContainer serverApps2 = echoServer.Install (nodes.Get (3));
